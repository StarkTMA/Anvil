...
def arcane_user_guide():
    ...
    # Attachable (optional)
    att = item.attachable
    # Add attachable visuals/animations if needed:
    # att.description.geometry("arcane_user_guide")
    # att.description.texture(blockbench_name="arcane_user_guide", component=TextureComponents(color="arcane_user_guide"))
    # att.description.render_controller("default")
