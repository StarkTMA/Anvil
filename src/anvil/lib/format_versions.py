...
BLOCK_SERVER_VERSION: str = "1.21.70"  # The version of the block server.
ENTITY_SERVER_VERSION: str = "1.21.70"  # The version of the entity server.
ENTITY_CLIENT_VERSION: str = "1.21.70"  # The version of the entity client.
...
ITEM_SERVER_VERSION: str = "1.21.70"  # The version of the item server.
...
RECIPE_JSON_FORMAT_VERSION = "1.21.70"  # The version of the recipe json format.
CRAFTING_ITEMS_CATALOG = "1.21.60" # The version of the crafting items catalog.

MODULE_MINECRAFT_SERVER: str = "1.17.0"  # The version of the Minecraft server module.
