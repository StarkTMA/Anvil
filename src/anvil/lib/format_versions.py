...
BLOCK_SERVER_VERSION: str = "1.21.80"  # The version of the block server.
ENTITY_SERVER_VERSION: str = "1.21.80"  # The version of the entity server.
ENTITY_CLIENT_VERSION: str = "1.21.80"  # The version of the entity client.
...
RECIPE_JSON_FORMAT_VERSION = "1.21.80"  # The version of the recipe json format.
CRAFTING_ITEMS_CATALOG = "1.21.60"  # The version of the crafting items catalog.

MODULE_MINECRAFT_SERVER: str = "1.19.0"  # The version of the Minecraft server module.
